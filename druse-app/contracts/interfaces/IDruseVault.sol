...
import {IDruseVaultFactory} from "./IDruseVaultFactory.sol";
...
interface IDruseVault is IERC20Upgradeable {
    // =============================================================
    //                            STRUCTS
    // =============================================================
    ...
    function vaultFactory() external view returns (IDruseVaultFactory);
     ...
     * @param to Recipient address for the pTOKEN
     */
    function mint(
        ...
        address depositor,
        address to
    ) external payable returns (uint256 pTokensMinted);
     ...
     * @param pTokenPremiumLimit The max net premium in pTOKEN the user is willing to pay, else tx reverts
    ...
    /**
     * @notice Calculate ETH amount corresponding to a given pTOKEN amount, calculated via TWAP from the Druse AMM
     */
    function pTokenToETH(uint256 pTokenAmount) external view returns (uint256);
