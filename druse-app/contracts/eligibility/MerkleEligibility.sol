...
/**
 * @title Druse Merkle Eligibility
 * @author Twade
 *
 * @notice Allows vaults to be allow eligibility based on a predefined merkle tree.
 */

abstract contract MerkleEligibility is Eligibility {
    /// @notice Emitted when our Druse Eligibility is deployed
    ...
    function __Eligibility_init_bytes(
        ...
        __Eligibility_init(_merkleRoot, _merkleReference, _merkleLeavesURI);
    }
