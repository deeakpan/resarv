...
import { robinhood, robinhoodTestnet } from "./chains/robinhood";
...
const UnsupportedMainnetFallback: React.FC = () => (
  ...
  >
    ...
    <Paragraph sx={{ mb: 3 }}>
      Please change your network to Robinhood Chain Testnet or Sepolia.
    </Paragraph>
...
const UnsupportedNetworkFallback: React.FC = () => (
  ...
  >
    ...
    Please switch to Robinhood Chain, Robinhood Chain Testnet, or Sepolia.
  </Flex>
);
            ...
            getDefaultConfig({
              ...
              chains:
                isDemoMode || import.meta.env.MODE === "test"
                  ...
                  ? [robinhoodTestnet, sepolia]
                  : [robinhood, robinhoodTestnet, mainnet, sepolia],
