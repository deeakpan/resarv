...
const rhDeployerKey = process.env.DEPLOYER_PRIVATE_KEY || process.env.PRIVATE_KEY;
const rhAccounts = rhDeployerKey
    ? [rhDeployerKey.startsWith("0x") ? rhDeployerKey : `0x${rhDeployerKey}`]
    : [];
const alchemyUrl = () => {
